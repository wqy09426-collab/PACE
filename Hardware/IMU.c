...
void IMU_getEuleranAngles(void)
{
	...
	imu_Angle.Pitch = asin(-2 * q[1] * q[3] + 2 * q[0]* q[2])* 57.2957f;
	imu_Angle.Roll  = atan2(2 * q[2] * q[3] + 2 * q[0] * q[1], -2 * q[1] * q[1] - 2 * q[2]* q[2] + 1)* 57.2957f;
	
	imu_Angle.Yaw  += imu_data.GZ* 57.2957f* cycle_T* 4;
